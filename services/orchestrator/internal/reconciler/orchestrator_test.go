...
func TestProductPages(t *testing.T) {
	...
	for _, path := range []string{"/platform", "/infrastructure", "/docs", "/login", "/register", "/dashboard", "/dashboard/servers", "/dashboard/infrastructure", "/dashboard/billing", "/dashboard/profile", "/staff"} {
